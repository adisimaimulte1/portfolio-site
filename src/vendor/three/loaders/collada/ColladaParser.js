...
class ColladaParser {
	...
	parse( text ) {
		...
		// BrickLink Studio exports nested library nodes without IDs. Assign them
		// before parsing so repeated LEGO parts do not collapse into one null key.
		this.prepareNodes( collada );
